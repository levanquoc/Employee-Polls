...
const About = () => {
  ...
  //   return storedActive ? storedActive : "New Question";
  // });
    ...
    <div>
      <div className="container mt-3">
        ...
        <table className="table" style={{border:'1px solid lightgray'}}>
          <thead>
            <tr>
              <th scope="col"><h2 className="text-center">New Question</h2></th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td>
                <div className="row">
                  {Object.entries(questions).sort((a, b) => b[1].timestamp - a[1].timestamp).map(([id, question]) => (
        ...
        <table className="table" style={{border:'1px solid lightgray'}}>
          <thead>
            <tr>
              <th scope="col"><h2 className="text-center">Done</h2></th>
            </tr>
          </thead>
          <tbody>
            <tr>
